This repository contains the scripts used to perform standard differential gene expression (DGE) and transcriptome-wide analyses described in our manuscript, "Convergence of Ageing-Associated Brain Transcriptomic Signatures in Neurodegenerative Mouse Models".
